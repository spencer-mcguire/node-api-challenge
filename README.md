...
- [ ] Describe Middleware?
      code that is reusable and can be passed around
- [ ] Describe a Resource?
      the actual data that lives in the database
- [ ] What can the API return to help clients know if a request was successful?
      status codes and a verbose response
- [ ] How can we partition our application into sub-applications?
      by using routes? it all depends on how you want to structure your files.
